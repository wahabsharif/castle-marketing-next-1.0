import GoogleLocation from "@/data/GulbergIslamabad/googleLocation";
import { introData } from "@/data/GulbergIslamabad/introData";
                ...
                .map((image, i) => (
                  <figure key={i} className="image-box">
                    <a className="lightbox-image" data-fancybox="gallery">
                      <Image
                        src={
                          require(`@/images/gulberg-islamabad/${image}`).default
                            .src
                        }
                        alt=""
                      />
