import GoogleLocation from "@/data/ParkViewCity/googleLocation";
import { introData } from "@/data/ParkViewCity/introData";
                ...
                .map((image, i) => (
                  <figure key={i} className="image-box">
                    <a className="lightbox-image" data-fancybox="gallery">
                      <Image
                        src={
                          require(`@/images/park-view-city/${image}`).default
                            .src
                        }
                        alt=""
                      />
