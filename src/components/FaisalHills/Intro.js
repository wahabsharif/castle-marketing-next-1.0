import GoogleLocation from "@/data/FaisalHills/googleLocation";
import { introData } from "@/data/FaisalHills/introData";
                ...
                .map((image, i) => (
                  <figure key={i} className="image-box">
                    <a className="lightbox-image" data-fancybox="gallery">
                      <Image
                        src={
                          require(`@/images/faisal-hills/${image}`).default.src
                        }
                        alt=""
                      />
                    </a>
