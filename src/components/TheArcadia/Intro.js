import GoogleLocation from "@/data/TheArcadia/googleLocation";
import { introData } from "@/data/TheArcadia/introData";
      ...
      <div className="auto-container">
        <Row className="clearfix">
                ...
                .map((image, i) => (
                  <figure key={i} className="image-box">
                    <a className="lightbox-image" data-fancybox="gallery">
                      <Image
                        src={
                          require(`@/images/the-arcadia/${image}`).default.src
                        }
                        alt=""
                      />
                    </a>
          ...
          <Col>
            <ul className="info">
              <li>
                <h4 className="text-center">Google Location.</h4>
                <GoogleLocation />
              </li>
            </ul>
          </Col>
