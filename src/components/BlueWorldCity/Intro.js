import GoogleLocation from "@/data/BlueWorldCity/googleLocation";
import { introData } from "@/data/BlueWorldCity/introData";
                ...
                .map((image, i) => (
                  <figure key={i} className="image-box">
                    <a className="lightbox-image" data-fancybox="gallery">
                      <Image
                        src={
                          require(`@/images/blue-world-city/${image}`).default
                            .src
                        }
                        alt=""
                      />
